...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    if ($nama_depan === '' || $nama_belakang === '' || $asal_kota === '' || $umur_raw === '') {
        ...
        echo '<div class="back"><a href="index.html">Kembali ke Registrasi Data</a></div>';
    }
    ...
    elseif (!ctype_digit((string)$umur_raw)) {
        ...
        if ($umur < 10) {
            ...
            echo '</tbody></table>';
            echo '<div class="back"><a href="index.html">Kembali ke Registrasi</a></div>';
        }
    }

} else {
    echo '<div class="err">Error: Data tidak ditemukan. Silakan isi data registrasi terlebih dahulu.</div>';
    echo '<div class="back"><a href="index.html">Kembali ke data Registrasi</a></div>';
}
?>
</div>
</body>
